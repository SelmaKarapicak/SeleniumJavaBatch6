...
public class RadioDemo {
		...
		System.out.println(maleRadioB.isDisplayed()); //ture
		...
		List<WebElement> proList = driver.findElements(By.xpath("//input[@name='profession']")); //list of web elements--> findElements
